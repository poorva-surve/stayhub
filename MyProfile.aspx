<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.master" AutoEventWireup="true"
    Theme="Theme" CodeFile="MyProfile.aspx.cs" Inherits="_Default" %>
        ...
        <div id="viewProfile" style="margin: auto;">
            ...
            <p align="right" style="margin: auto; width: 100%">
                ...
                <ajaxToolkit:ConfirmButtonExtender ID="ConfirmButtonExtender1" runat="server" TargetControlID="btnDelete"
                    ConfirmText="All details of your account including interests and PG visits will be permanently deleted. Do you want to continue?" />
            </p>
            <br />
            <div class="rounded-lg shadow">
                <asp:DataList ID="DataListProfile" runat="server" Width="100%" Style="font-family: Arial, Helvetica, sans-serif;
                    font-size: 1em" EnableTheming="True" DataSourceID="SqlDataSourceUsers" OnPreRender="DataListProfile_PreRender">
                    <ItemTemplate>
                        <table style="padding: 0; margin: auto; border: 2px solid #FFCC66" cellpadding="20"
                            ...
                            <tr>
                                <td colspan="3" bgcolor="#FFCC66" style="border-style: none; border-width: 0px; padding: 1em;
                                    color: #800000;">
                                    <asp:Label ID="lblName" runat="server" Font-Size="1.5em" Text='<%# Eval("Name") %>'
                                        Style="font-weight: 700; display: run-in;"></asp:Label>
                                    <asp:TextBox ID="txtName" runat="server" placeholder="Enter your name" Font-Size="1.5em"
                                        Text='<%# Eval("Name") %>' Style="font-weight: 700;" Visible="False" SkinID="adm" />
                                    ...
                                    &nbsp; <span style="float: right">
                                        <asp:Label ID="lblID" runat="server" Font-Size="1.3em" Text='<%# Eval("ID") %>' Visible="True"></asp:Label><br />
                                    </span>
                                    <br />
                                    <asp:Label ID="lblCity" runat="server" Text='<%# Eval("City") %>'></asp:Label>
                                    <asp:TextBox ID="txtCity" runat="server" placeholder="Enter your city" Font-Size="1.3em"
                                        Text='<%# Eval("City") %>' Style="font-weight: 700;" Visible="False" SkinID="adm" />
